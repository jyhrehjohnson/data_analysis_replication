...
## References
Christopher M. Martinez, John S. Sparks. 2017. Malagasy cichlids differentially limit impacts of body shape evolution on oral jaw functional morphology. Evolution. Volume 71, Issue 9 p. 2219-2229. https://onlinelibrary.wiley.com/doi/10.1111/evo.13298
...
e = eigen(cov(bs_data[, -1]))
head(e,3)

e.scaled = eigen(cov(bs_data_scaled))
head(e.scaled,3)
...
bs_data_pc  = as.matrix(bs_data_scaled) %*% e.scaled$vectors 
head(bs_data_pc,3)
...
autoplot(bs_pca, data  = bs_data_mod, colour = 'genus') #plot the pca coloring the data by genus 
```
